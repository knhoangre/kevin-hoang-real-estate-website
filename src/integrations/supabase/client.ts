...
const createMockClient = () => {
  ...
  /*
   * Typed as the real client so every call site is checked against the
   * generated Database. This used to be `as any`, which collapsed the union
   * below to `any` and switched off type checking for every Supabase call in
   * the app.
   */
