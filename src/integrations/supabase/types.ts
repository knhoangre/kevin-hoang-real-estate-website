// Generated by the Supabase CLI. Do not hand-edit.
//
//   npx supabase gen types typescript --project-id zvipgykolpoxukyjgffx \
//     > src/integrations/supabase/types.ts
//
// Regenerate after any schema change. This file previously described only
// 8 of the 29 tables and views that exist, which is how every Supabase call
// in the app went unchecked.
